CREATE DATABASE  IF NOT EXISTS `atenea` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `atenea`;
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: atenea
-- ------------------------------------------------------
...
DROP USER IF EXISTS 'atenea'@'localhost';
CREATE USER 'atenea'@'localhost' IDENTIFIED BY 'atenea';
...
CREATE TABLE `usuario` (
  ...
  `Tipo` set('Usuario','Funcionario') NOT NULL,
  PRIMARY KEY (`CI`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
GRANT ALL PRIVILEGES ON atenea.* TO 'atenea'@'%' WITH GRANT OPTION;

--
-- Dumping events for database 'atenea'
--
...
-- Dump completed on 2016-06-07 14:32:06
